...
com_otu <- otu_table(combo_OTU_matrix, taxa_are_rows = F)
  ##"Taxa" table
com_tax <- bind_rows(tej_tax, mendo_tax, erl_tax) %>% mutate(Kingdom = rep("Fungi"))
...
p_com = plot_ordination(com_ps, com_ps_ord, type="species")
print(p_com)
...
p2_com_tr = plot_ordination(com_trait_ps, com_trait_ps_ord, type="taxa", color="enviro", shape = "enviro") 
print(p2_com_tr)
#TO PLOT BY TRAIT
